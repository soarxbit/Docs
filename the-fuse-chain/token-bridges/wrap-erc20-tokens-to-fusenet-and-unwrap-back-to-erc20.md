---
description: Steps to transfer/wrap SOARX20 tokens from Ethereum to Fusenet
---

# Bridge for SOARX20 tokens

Please use this tutorial at your own risk as it involves using Etherscan UI/Soarx explorer to relay the tokens.
