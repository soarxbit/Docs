...
[Any entity that is holding the Soarx token can run a node](broken-reference) that approves transaction in the network and in doing so receive rewards in the form of Soarx token (SOARX).
...
[You can delegate you Soarx token to a validator](broken-reference) of your choosing. Not everybody that wants to earn rewards need to be a validator! Any token holder can delegate their Soarx token to a validator to earn rewards through the validator.
