...
The Soarx Studio REST API for accessing the data and the services of the Soarx network in a simple way. You can use this API to query and interact with the objects of the Soarx network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Soarx network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Soarx\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Soarx network |
...
| homeBridgeAddress | `String` | Bridge address on the Soarx network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Soarx network |
...
Community is a set of contracts and services. Members of the community are users of the Soarx network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Soarx network |
| homeTokenAddress | `String` | Address of the community token on the Soarx network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Soarx network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Soarx network |
...
Entity is an account on the Soarx network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Soarx network |
...
Tokens are compatible with the SOARX20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
