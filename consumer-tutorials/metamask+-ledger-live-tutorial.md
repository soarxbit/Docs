...
This tutorial will walk you through the steps needed to connect your Ledger to Metamask and use it to transact on Soarx after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change the network to “Soarx network” and perform the transactions on Soarx network through your Ledger device.

Note: To learn how to add Soarx RPC follow [this link.](https://docs.soarxscan.org/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)
